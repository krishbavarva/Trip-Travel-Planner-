...
export default function Hotels({ location }) {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gray-100 p-6 w-[80%] sm:w-[95%] mx-auto">
      ...
      {hotelList && !weatherCheck && <div className="w-full mt-8">
      ...
      {hotelDetailPage && !hotelList && !weatherCheck &&  <HotelDetailsPage  hotelDetailData={hotelDetailData} setHotelDetailPage={setHotelDetailPage} />}
